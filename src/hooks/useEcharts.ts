// The suffix of series type definitions is SeriesOption
import type {
  BarSeriesOption,
  LineSeriesOption,
  PieSeriesOption,
...
// The suffix of component type definitions is ComponentOption
import type {
...
import {
  ...
  ToolboxComponent,
  TooltipComponent,
  TransformComponent, // Built-in data transformer components (filter, sort)
} from 'echarts/components'
 ...
 * @description Import chart components as needed. Unregistered components need to be imported first.
 */
